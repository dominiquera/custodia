            ...
            $(document).on('change', '.interval_repeatable', function () {
              if($(this).attr('data-key')){
                ...
                weekly = "       <div class=\"field-group\" style=\"display: flex; margin-top: 10px;\">\n" +
                    ...
                    "            </div>" +
                    "            <div class=\"field-group\" style=\"display: flex; margin-top: 10px;\">\n" +
                    "                <input required type=\"text\" name=\"months["+row2+"][descriptions][1][text]\" id=\"description\">\n" +
                    "                <input required id=\"photo\" type=\"file\" class=\"form-control\" name=\"months["+row2+"][descriptions][1][photos]\" style=\"border:none;\">\n" +
                    "            </div>" +
                    "            <div class=\"field-group\" style=\"display: flex; margin-top: 10px;\">\n" +
                    "                <input required type=\"text\" name=\"months["+row2+"][descriptions][2][text]\" id=\"description\">\n" +
                    "                <input required id=\"photo\" type=\"file\" class=\"form-control\" name=\"months["+row2+"][descriptions][2][photos]\" style=\"border:none;\">\n" +
                    "            </div>" +
                    "            <div class=\"field-group\" style=\"display: flex; margin-top: 10px;\">\n" +
                    "                <input required type=\"text\" name=\"months["+row2+"][descriptions][3][text]\" id=\"description\">\n" +
                    "                <input required id=\"photo\" type=\"file\" class=\"form-control\" name=\"months["+row2+"][descriptions][3][photos]\" style=\"border:none;\">\n" +
                    "            </div>";
