    ...
    <div class="ui container" style="padding-top:50px;">
        ...
        <form action="/admin/maintenance_items/update" method="POST" class="ui form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="url" name="video" class="form-control" id="video" placeholder="Video" value="{{$item->video}}">
            </div>
            <div class="tools">
                @foreach($item->tools as $tools)
                    <div class="form-group">
                        <label>Tool</label><br>
                        <input name="tools[]" class="form-control" placeholder="Tool" style="width: 88%;" value="{{$tools->value}}">
                ...
                @foreach ($item->months as $month)
                    <div class="field-group" style="display: flex; margin-top: 10px;">
                        <select class="form-control" name="months[]" id="month_{{$month->id}}">
                            ...
                            <option value="August" @if ($month->month == "August") selected="selected" @endif >August
                            </option>
                            <option value="September" @if ($month->month == "September") selected="selected" @endif >
                                September
                            </option>
                        ...
                        <input id="photo" type="file" class="form-control" name="photos[]" id="photos_{?}"
                               style="border:none;">
